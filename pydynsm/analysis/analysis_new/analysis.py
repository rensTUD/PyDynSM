...
class Analysis:
    ...
    def ElementForces(self, elements, u_nodes_global, omega, num_points=20):
        ...
        for element in elements:
            ...
            # Calculate the Forces for the element using its Forces method
    ...
    def ElementStresses(self, elements, u_nodes_global, omega, num_points=20):
        ...
        element_stresses : dict
            Dictionary with element IDs as keys and their global stresses (as numpy arrays) as values.
        """
        ...
        for element in elements:
            ...
            # Calculate the Forces for the element using its Forces method
            sigma_elem = element.Stresses(u_element_global, omega, num_points)
    
            # Store the displacements in the dictionary using the element's ID
            element_stresses[element.id] = sigma_elem
