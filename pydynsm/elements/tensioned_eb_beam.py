...
@ElementFactory.ElementType('Tensioned EB Beam')
class Tensioned_EB_Beam(StructuralElement):
    ...
    def LocalStiffness(self, omega):
        ...
        EI = self.E*self.Ib*(1+2j*self.ksi)
        Ib = self.Ib
        E = self.E
        T = self.T
        L = self.L
...
ElementFactory.RegisterElement(Tensioned_EB_Beam)